...
$req="SELECT*FROM client WHERE cin='$cin' AND email='$name'";
$res=mysql_query($req);
if(mysql_num_rows($res)<=0){
	echo "<p align='center' style='color:green;font-family:forte;font-size:50px'><b>This Client doesn't exist you can register and order </b></p> <br><br>";
	?>
	<div align="center">
	<a href="check.html" align="center"><input type="submit" value="Go Back" align="center"></a>
	</div>
	<?php
